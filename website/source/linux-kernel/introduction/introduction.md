...
<div class="balloon">
  ...
  <div class="balloon-text-right">
    グローバル変数のように競合する可能性のあるデータを使うときはロックを取らないと<br>いけないってことだね。ドライバのプログラミングって大変だ〜。
  </div>
</div>
...
<div class="column" title="例題">
  <a href="#">練習問題LK01</a>のファイルをダウンロードして以下の操作を実行しましょう。<br>
  (1) <code>run.sh</code>を実行して、Linuxが立ち上がることを確認してください。<br>
  (2) 起動時にシェルがroot権限になるように<code>rootfs.cpio</code>を編集してください。
</div>
